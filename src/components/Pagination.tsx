  ...
  return (
    <div className='p-4 flex items-center justify-between text-gray-500'>
        ...
        <div className='flex items-center gap-2 text-sm'>
            <button className='px-2 py-1 rounded-sm cursor-pointer bg-sky'>1</button>
            <button className='px-2 py-1 rounded-sm cursor-pointer '>2</button>
            <button className='px-2 py-1 rounded-sm cursor-pointer '>3</button>
            ...
            <button className='px-2 py-1 rounded-sm cursor-pointer '>10</button>
        </div>
